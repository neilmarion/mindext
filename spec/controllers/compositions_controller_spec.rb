  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested composition" do
        composition = Composition.create! valid_attributes
        # Assuming there are no other compositions in the database, this
        ...
        put :update, {:id => composition.to_param, :composition => {'these' => 'params'}}, valid_session
      end

      it "assigns the requested composition as @composition" do
        composition = Composition.create! valid_attributes
        put :update, {:id => composition.to_param, :composition => valid_attributes}, valid_session
        assigns(:composition).should eq(composition)
      end
    ...
    describe "with invalid params" do
      it "assigns the composition as @composition" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Composition.any_instance.stub(:save).and_return(false)
        put :update, {:id => composition.to_param, :composition => {}}, valid_session
        assigns(:composition).should eq(composition)
      end
